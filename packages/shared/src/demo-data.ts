...
export const skillCatalog: SkillDescriptor[] = [
  {
    id: "daily-briefing",
    name: "Daily Briefing",
    category: "lifestyle",
...
export const householdModules: HouseholdModule[] = [
  {
    id: "briefing",
...
export const pairingSession: PairingSession = {
  code: "HH-7K2P",
  expiresInSeconds: 180,
  qrPayload: "homehub://pair?box=homehub-living-room&code=HH-7K2P"
};

export const boxProfile: BoxProfile = {
...
export const relayMessages: RelayMessage[] = [
  {
    id: "r1",
    source: "mobile-app",
    kind: "voice",
