...
def derive_refined_queries(
    ...
    ai_rewrites: list[str] | None = None,
) -> list[str]:
...
def suggest_ai_rewrites(
    ...
    openai_chat_json: Callable[[str, str, str], dict[str, Any] | None] | None,
) -> list[str]:
...
def run_iterative_network_lookup(
    ...
    route_hints: dict[str, Any] | None,
    build_query_candidates: Callable[[str, str, list[str] | None], list[str]],
    perform_network_lookup: Callable[[str, str, str, list[str] | None, list[str] | None], dict[str, Any]],
    build_grounded_reply: Callable[[str, dict[str, Any], str], str],
    is_weak_grounded_reply: Callable[[str], bool],
    openai_chat_json: Callable[[str, str, str], dict[str, Any] | None] | None = None,
) -> dict[str, Any]:
    query = str(query_text or "").strip()
    if not query:
